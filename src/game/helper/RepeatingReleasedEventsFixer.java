 ...
 * KeyEvent handling for keyboard repeat. Linux apparently implements repeating
 * keypresses by repeating both the {@link KeyEvent#KEY_PRESSED} and
 ...
 * {@link RepeatingReleasedEventsFixer}, AWTEvent.KEY_EVENT_MASK);
 * 
 * 
 * 
 ...
 * Mode of operation
 * 
 * The class makes use of the fact that the subsequent PRESSED event comes right
 * after the RELEASED event - one thus have a sequence like this:
 * 
 * 
 * 
 ...
 * that denotes that the key actually was released.
 * 
 * 
...
public class RepeatingReleasedEventsFixer implements AWTEventListener {
    ...
    */
   public class ReleasedAction implements ActionListener {
